...
public class OllamaService {
    ...
    // Track the dimensionality of embeddings
    private int embeddingDimension = 384; // Default, will be updated after first embedding
    ...
    public float[] getEmbedding(String text) throws IOException {
        ...
        // Create a JSON object properly using Gson
    ...
    public String generateCodeContext(String query, List<CodeSearchResult> results) throws IOException {
        ...
        JsonObject jsonRequest = new JsonObject();
        jsonRequest.addProperty("model", GENERATION_MODEL);
        jsonRequest.addProperty("prompt", "Based on the user query and the matching files, provide a brief explanation of which files " +
                "are most relevant and why. Focus on how these files relate to the functionality the user is looking for:\n\n" +
